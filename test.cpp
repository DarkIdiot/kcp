...
void test(int mode)
{
    ...
    int user1 = 0;
    int user2 = 1;
    ikcpcb *kcp1 = ikcp_create(0x11223344, &user1);
    ikcpcb *kcp2 = ikcp_create(0x11223344, &user2);
